...
const SAFETY_ZONES = [
  { range: 8, label: '🔴 อันตรายสูง', desc: '0-20 กม.', color: '#dc2626', fillOpacity: 0.30 },
  { range: 18, label: '🟠 อันตรายปานกลาง', desc: '20-50 กม.', color: '#ea580c', fillOpacity: 0.22 },
  { range: 35, label: '🟡 ระวัง', desc: '50-100 กม.', color: '#eab308', fillOpacity: 0.15 },
  { range: 55, label: '🟢 ค่อนข้างปลอดภัย', desc: '100-180 กม.', color: '#22c55e', fillOpacity: 0.10 },
  { range: 75, label: '🔵 ปลอดภัย', desc: '180+ กม.', color: '#3b82f6', fillOpacity: 0.06 },
]
